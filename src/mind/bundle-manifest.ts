...
export const CANONICAL_BUNDLE_MANIFEST: readonly BundleManifestEntry[] = [
  ...
  { path: "arc/flight-recorder/context-loss-sentinel", kind: "dir" },
  { path: "arc/flight-recorder/context-loss-sentinel/history", kind: "dir" },
  { path: "arc/flight-recorder/context-loss-sentinel/receipts", kind: "dir" },
