...
export type VaultCliCommand = Extract<OuroCliCommand, { kind: "vault.create" } | { kind: "vault.recover" } | { kind: "vault.unlock" } | { kind: "vault.status" } | { kind: "vault.config.set" } | { kind: "vault.config.status" }>
