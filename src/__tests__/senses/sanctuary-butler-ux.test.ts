...
describe("Mendelow Cloud Butler household UX", () => {
  ...
  it("enforces family privacy with the packaged relationship evaluator at advertisement and execution", async () => {
    ...
    expect(advertised).toEqual(["await_condition", "cancel_await", "unraid_list_containers", "unraid_get_storage", "unraid_get_disks", "unraid_get_system", "unraid_check_services", "unraid_restart_container", "settle", "speak"])
