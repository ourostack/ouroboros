 ...
 *
 * `readDaemonHealthDeep` is the mailbox-side reader that parses a
 * daemon-health.json file into the `MailboxDaemonHealthDeep` DTO. The
 ...
 * `DaemonStatus | "unknown"` so downstream Mailbox consumers can rely
...
import { readDaemonHealthDeep } from "../../../../heart/mailbox/readers/runtime-readers"
