...
describe("Sanctuary acceptance adapter semantic proofs", () => {
  ...
  it("captures exact redacted Unit-16e containment evidence from packaged profiles, host inventory, audit, and container policy", async () => {
    ...
    const files: Record<string, string> = {
      ...
      "/opt/ouro/deploy/unraid/sanctuary.ouro/tool-profiles.json": JSON.stringify({ version: 2, profiles: { "sanctuary-owner": { version: 1, contextScopes: [], toolNames: telegramTools, effectScopes: [] }, "sanctuary-event": { version: 1, contextScopes: [], toolNames: privateTools, effectScopes: [] } } }),
    }
