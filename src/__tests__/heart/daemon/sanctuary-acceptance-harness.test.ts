...
describe("Sanctuary acceptance harness", () => {
  ...
  const validAssertions = (label: string): Record<string, unknown> => {
    switch (label) {
      ...
      case "unit-16c-provider-readiness": return { baseUrlExact: true, innerReady: true, laneSelectionExact: true, outwardReady: true, silentFallback: false, singleCredentialExact: true, vaultCoordinatesExact: true }
