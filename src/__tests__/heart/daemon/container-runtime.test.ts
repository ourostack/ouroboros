...
describe("container runtime policy", () => {
  ...
  it("ships Mendelow Cloud Butler with the exact persistent roots and complete bootstrap bundle", () => {
    ...
    expect(updateRunbook.indexOf('audit_effective ouro-butler "$ROLLBACK_IMAGE_ID"')).toBeLessThan(updateRunbook.indexOf("\n    docker start ouro-butler\n"))
    expect(updateRunbook.indexOf('audit_effective ouro-butler "$IMAGE_ID"')).toBeLessThan(updateRunbook.lastIndexOf("\n    docker start ouro-butler\n"))
    ...
    const rollbackStart = updateRunbook.indexOf("\n    docker start ouro-butler\n")
    ...
    const productionStart = updateRunbook.lastIndexOf("\n    docker start ouro-butler\n")
