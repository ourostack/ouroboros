...
The household's prepaid download provider is Astraweb. Its public account and top-up entry is https://www.astraweb.com/login. Never ask for or expose account credentials; send Ari that public link when a human top-up is the next step, then verify recent successful articles and a completed download before calling the path recovered.
