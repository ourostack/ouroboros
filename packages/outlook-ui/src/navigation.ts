...
export type TabId = "overview" | "sessions" | "work" | "connections" | "inner" | "memory" | "runtime"
...
const VALID_TABS = new Set<string>(["overview", "sessions", "work", "connections", "inner", "memory", "runtime"])
